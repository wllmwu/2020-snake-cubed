...
public class Cube : MonoBehaviour {
    ...
    ///<summary>Sets the Cube's coordinates in game space.</summary>
    ///<param name="coordinates">An integer array containing, in order, the x, y, and z coordinates in game space to be set to.</param>
    ...
    ///<summary>Sets the Cube's coordinates in game space to those given and sets its position to that described by them.</summary>
